define(['controllerBase'], function (ControllerBase) {
    ...
    var controller = new ControllerBase('OrdensServico', 'ProgramacaoInternas');
    ...
    angular
        ...
        .registerController(controller.name, function ($scope,
            ...
            $scope.imprimirDocumentos = function () {
                ...
                $scope.modelProgrmacao.exibeMapa = false;
            ...
            $scope.imprimirListaDocumentos = function () {
                ...
                if (ordenacao != undefined) {
                    rota = rota + 'campo=' + ordenacao[0] + '&direcao=' + ordenacao[1] + '&exibeMapa=false';
                }
                else {
                    rota = rota + 'campo=-1&direcao=undefined' + '&exibeMapa=false';
                }
