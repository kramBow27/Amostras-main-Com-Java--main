define(['componentBase'], function (ComponentBase) {
    ...
    var component = new ComponentBase('Baixas');
    ...
    var moduleConfig = {
        states: [
            ...
            { name: moduleName + '.detalhes', abstract: false, url: '/detalhes/:id/?baixas', templateUrl: moduleName + '.detalhes', controller: moduleName + 'DetalhesController' },
            ...
            { name: moduleName + '.consultar', abstract: false, url: '/consultar/:tipoRecursoId', templateUrl: moduleName + '.consultar', controller: moduleName + 'ConsultarController' },
